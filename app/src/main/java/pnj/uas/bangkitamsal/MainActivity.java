...
import pnj.uas.bangkitamsal.fragment.BeritaFragment;
import pnj.uas.bangkitamsal.fragment.HomeFragment;
import pnj.uas.bangkitamsal.fragment.ProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId() == R.id.actionJalur) {
            Intent intent = new Intent( this, DataJalurActivity.class);
            startActivity(intent);
        }else if(item.getItemId() == R.id.actionPendaki) {
            Intent intent = new Intent( this, ListDataPendaki.class);
            startActivity(intent);
